...
\textbf{\uppercase{ROSS GORE}} is a research assistant professor at VMASC. His email is \email{ross.gore@gmail.com}.

\textbf{\uppercase{PHILLIP WOZNY}} recently completed his Masters of Science. His email is \email{phillipjw@gmail.com}. 

\textbf{\uppercase{FRANK P.M. DIGNUM}} is an associate professor at Utrecht University. His email is \email{f.p.m.dignum@uu.nl}.

\textbf{\uppercase{F. LERON SHULTS}} directs the NORCE Research Institute. His email is \email{leron.shults@uia.no}.

\textbf{\uppercase{CHRISTINE BOSHUJZEN-VAN BURKEN}} is a postdoc researcher. Her email is \email{c.g.boshuijzen@tue.nl}.

\textbf{\uppercase{LAMBER ROYAKKERS}} is an associate professor at TU/e. His email is \email{l.m.m.royakkers@tue.nl}.
